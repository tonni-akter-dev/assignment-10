        ...
        <div>
            <Row xs={1} md={2} className="container m-auto mt-5">
                <Col className="pt-5 mb-5">
                    ...
                    <Link to="/doctors">
                    <Button className="button-design text-light"><small>Find doctors</small> <i className="fas fa-arrow-right"></i></Button> 
                    </Link>
                    <br /> <br />
                    {/* appontment button */}
                  <Link to="/appointment">
                  <Button className="button-design text-light"><small>Appointment</small>  <i className="fas fa-arrow-right"></i></Button></Link>
                    <br /><br />
