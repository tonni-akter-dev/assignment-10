            ...
            <Row className='gy-4'>
                <Col sm={12} md={12} lg={5}>
                    ...
                    <div className='mt-4'>
                        ...
                        <button className='me-3 btn-danger'><i className="fa-2x text-white fab fa-instagram-square"></i></button>
                        <button className='me-3 btn-danger'><i className="fa-2x text-white fab fa-youtube"></i></button>
                    </div>
                </Col>
                ...
                <Col sm={12} md={12} lg={4}>
                    ...
                    <div>
                        <div className='mb-2'><i className="me-2 fs-4 fas fa-street-view"></i>Sector-10, Uttara Dhaka-1230</div>
                        <div className='mb-2'><i className="me-2 fs-4 fas fa-phone-alt"></i>+880 1795443674</div>
                        <div><i className="me-2 fs-4 fas fa-envelope-open-text"></i>medizoid.health@gmail.com</div>
